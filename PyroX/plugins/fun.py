...
@PyroX.on_message(filters.command("cat", prefixes=HANDLER) & filters.user(OWNER_ID))
...
@PyroX.on_message(filters.regex("baka") & filters.user(OWNER_ID))
...
@PyroX.on_message(filters.regex("hug") & filters.user(OWNER_ID))
...
@PyroX.on_message(filters.command("in", prefixes=HANDLER) & filters.user(OWNER_ID))
...
@PyroX.on_message(filters.command("ri", prefixes=HANDLER) & filters.user(OWNER_ID))
...
@PyroX.on_message(filters.command("gt", prefixes=HANDLER) & filters.user(OWNER_ID))
