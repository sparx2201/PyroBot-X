...
@PyroX.on_message(filters.command("video",prefixes=HANDLER) & filters.user(OWNER_ID))
...
@PyroX.on_message(filters.command("song",prefixes=HANDLER) & filters.user(OWNER_ID))
