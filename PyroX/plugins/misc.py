...
@PyroX.on_message(filters.command(["ud","define"],prefixes=HANDLER) & filters.user(OWNER_ID))
...
trans = Translator()
@PyroX.on_message(filters.command("tr",prefixes=HANDLER) & filters.user(OWNER_ID))
