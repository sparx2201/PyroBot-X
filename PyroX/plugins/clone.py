...
@PyroX.on_message(filters.command("cpfp",config.HANDLER) & filters.user(config.OWNER_ID))
...
@PyroX.on_message(filters.command("savepfp", config.HANDLER) & filters.user(config.OWNER_ID))
...
@PyroX.on_message(filters.command("rnpfp", config.HANDLER) & filters.user(config.OWNER_ID))
